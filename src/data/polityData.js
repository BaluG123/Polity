    ...
    topics: [
      {
        ...
        description: "Ensures equal treatment and non-discrimination",
        concepts: [
          {
            id: "article_14",
            title: "Article 14 - Equality before Law",
            content: "The State shall not deny to any person equality before the law or the equal protection of the laws within the territory of India.\n\nKey Points:\n• Equality before law - British concept (negative)\n• Equal protection of laws - American concept (positive)\n• Applies to all persons, not just citizens\n• Permits reasonable classification\n• Prohibits class legislation\n\nReasonable Classification:\n1. Must be based on intelligible differentia\n2. Differentia must have rational relation to object\n3. Examples: Income tax slabs, reservation policies\n\nLandmark Cases:\n• State of West Bengal v. Anwar Ali Sarkar (1952)\n• E.P. Royappa v. State of Tamil Nadu (1974)",
            keywords: ["equality", "article 14", "equal protection", "reasonable classification"],
            examTips: "Article 14 is the foundation of all other fundamental rights. Remember the difference between equality before law and equal protection of laws."
          },
          {
            id: "article_15",
            title: "Article 15 - Prohibition of Discrimination",
            content: "The State shall not discriminate against any citizen on grounds only of religion, race, caste, sex or place of birth.\n\nKey Features:\n• Applies only to citizens\n• Prohibits discrimination in public places\n• Allows special provisions for women, children, and backward classes\n• Exception: Article 15(4) and 15(5) for reservations\n\nClause-wise Analysis:\n• Clause (1): General prohibition\n• Clause (2): Access to public places\n• Clause (3): Special provisions for women and children\n• Clause (4): Reservations for backward classes (1st Amendment)\n• Clause (5): Reservations in educational institutions (93rd Amendment)\n\nImportant Cases:\n• Champakam Dorairajan case (1951)\n• Indra Sawhney case (1992) - Mandal Commission",
            keywords: ["discrimination", "article 15", "religion", "caste", "sex", "reservations"],
            examTips: "Article 15(4) added by 1st Amendment allows reservations for backward classes. Article 15(5) added by 93rd Amendment allows reservations in educational institutions."
          },
          {
            id: "article_16",
            title: "Article 16 - Equality of Opportunity in Public Employment",
            content: "There shall be equality of opportunity for all citizens in matters relating to employment or appointment to any office under the State.\n\nKey Provisions:\n• Equal opportunity in public employment\n• No discrimination on grounds of religion, race, caste, sex, descent, place of birth, residence\n• Parliament can prescribe residence requirements\n• Reservations for backward classes, SCs, STs\n\nClauses:\n• Clause (1): General equality\n• Clause (2): No discrimination\n• Clause (3): Residence requirement\n• Clause (4): Reservations (backward classes)\n• Clause (4A): Reservations in promotions (77th Amendment)\n• Clause (4B): Unfilled reserved posts (81st Amendment)\n• Clause (5): Religious institutions exemption\n\nLandmark Judgments:\n• Indra Sawhney v. Union of India (1992) - 50% ceiling\n• M. Nagaraj v. Union of India (2006) - Promotion reservations",
            keywords: ["public employment", "article 16", "reservations", "backward classes"],
            examTips: "Remember the 50% ceiling on reservations established in Indra Sawhney case. Article 16(4A) allows reservations in promotions."
          },
          {
            id: "article_17",
            title: "Article 17 - Abolition of Untouchability",
            content: "Untouchability is abolished and its practice in any form is forbidden. The enforcement of any disability arising out of untouchability shall be an offence punishable in accordance with law.\n\nKey Features:\n• Abolishes untouchability completely\n• Makes its practice a punishable offence\n• Both positive and negative right\n• Self-executing provision\n• Enforceable against individuals too\n\nImplementing Legislation:\n• Protection of Civil Rights Act, 1955 (earlier Untouchability Offences Act, 1955)\n• Scheduled Castes and Scheduled Tribes (Prevention of Atrocities) Act, 1989\n\nSignificance:\n• Social reform measure\n• Promotes human dignity\n• Removes social disabilities\n• Ensures social equality",
            keywords: ["untouchability", "article 17", "social equality", "civil rights"],
            examTips: "Article 17 is unique as it's enforceable against private individuals too, not just the State."
          },
          {
            id: "article_18",
            title: "Article 18 - Abolition of Titles",
            content: "No title, not being a military or academic distinction, shall be conferred by the State. No citizen of India shall accept any title from any foreign State.\n\nKey Provisions:\n• State cannot confer titles (except military/academic)\n• Citizens cannot accept foreign titles\n• Foreigners holding office of profit cannot accept titles\n• Trade titles are not prohibited\n\nExceptions:\n• Military distinctions (Param Veer Chakra, Ashok Chakra)\n• Academic distinctions (D.Litt., Ph.D.)\n\nNational Awards (Not Titles):\n• Bharat Ratna\n• Padma Vibhushan\n• Padma Bhushan\n• Padma Shri\n\nRationale:\n• Promotes equality\n• Prevents creation of privileged class\n• Democratic principle",
            keywords: ["titles", "article 18", "military distinction", "academic distinction"],
            examTips: "National awards like Bharat Ratna are not titles but honors. Military and academic distinctions are exceptions."
          }
        ]
      },
      {
        ...
        description: "Protects individual liberty and freedom of expression",
        concepts: [
          {
            id: "article_19",
            title: "Article 19 - Protection of Certain Rights regarding Freedom of Speech",
            content: "All citizens shall have the right to freedom of speech and expression, assembly, association, movement, residence, and profession.\n\nSix Freedoms under Article 19(1):\n1. Freedom of speech and expression (a)\n2. Freedom to assemble peaceably and without arms (b)\n3. Freedom to form associations or unions (c)\n4. Freedom to move freely throughout India (d)\n5. Freedom to reside and settle in any part of India (e)\n6. Freedom to practice any profession or carry on any occupation, trade or business (g)\n\nNote: Article 19(1)(f) - right to acquire property was deleted by 44th Amendment\n\nReasonable Restrictions:\n• Security of State\n• Friendly relations with foreign states\n• Public order\n• Decency or morality\n• Contempt of court\n• Defamation\n• Incitement to offence\n\nLandmark Cases:\n• Romesh Thappar v. State of Madras (1950)\n• Maneka Gandhi v. Union of India (1978)\n• Shreya Singhal v. Union of India (2015)",
            keywords: ["freedom of speech", "article 19", "reasonable restrictions", "assembly"],
            examTips: "Remember the 6 freedoms and their corresponding reasonable restrictions. Property right was removed by 44th Amendment."
          },
          {
            id: "article_20",
            title: "Article 20 - Protection in respect of Conviction for Offences",
            content: "No person shall be convicted of any offence except for violation of a law in force at the time of commission of the act, nor be subjected to a penalty greater than that prescribed by law.\n\nThree Protections:\n1. No ex-post-facto law (Clause 1)\n2. No double jeopardy (Clause 2)\n3. No self-incrimination (Clause 3)\n\nEx-Post-Facto Law:\n• No retrospective criminal law\n• Cannot be punished for act not illegal when committed\n• Exception: Tax laws can be retrospective\n\nDouble Jeopardy:\n• Cannot be prosecuted twice for same offence\n• Must be by court of competent jurisdiction\n• Applies only to criminal cases\n\nSelf-Incrimination:\n• Right to remain silent\n• Cannot be compelled to be witness against oneself\n• Includes testimonial compulsion only\n\nImportant Cases:\n• Keshavan Madhava Menon v. State of Bombay (1951)\n• State of Bombay v. Kathi Kalu Oghad (1961)",
            keywords: ["conviction", "article 20", "ex-post-facto", "double jeopardy", "self-incrimination"],
            examTips: "Article 20 provides three protections against arbitrary criminal prosecution. Remember the exceptions and limitations."
          },
          {
            id: "article_21",
            title: "Article 21 - Protection of Life and Personal Liberty",
            content: "No person shall be deprived of his life or personal liberty except according to procedure established by law.\n\nEvolution of Article 21:\n• Originally narrow interpretation\n• Maneka Gandhi case (1978) - revolutionary expansion\n• 'Procedure established by law' must be fair, just and reasonable\n\nExpanded Rights under Article 21:\n• Right to live with dignity\n• Right to privacy\n• Right to health\n• Right to education\n• Right to clean environment\n• Right to speedy trial\n• Right to legal aid\n• Right to shelter\n• Right against custodial violence\n• Right to know\n• Right to reputation\n\nLandmark Cases:\n• A.K. Gopalan v. State of Madras (1950) - narrow interpretation\n• Maneka Gandhi v. Union of India (1978) - watershed moment\n• Francis Coralie Mullin v. Administrator, UT of Delhi (1981)\n• Olga Tellis v. Bombay Municipal Corporation (1985)\n• Vishaka v. State of Rajasthan (1997)\n• K.S. Puttaswamy v. Union of India (2017) - Privacy",
            keywords: ["life", "personal liberty", "article 21", "due process", "dignity"],
            examTips: "Article 21 is the most expanded fundamental right. Maneka Gandhi case transformed its interpretation from 'procedure established by law' to 'due process'."
          },
          {
            id: "article_22",
            title: "Article 22 - Protection against Arrest and Detention",
            content: "No person who is arrested shall be detained in custody without being informed of the grounds for such arrest nor shall he be denied the right to consult and be defended by a legal practitioner of his choice.\n\nRights of Arrested Person:\n1. Right to be informed of grounds of arrest\n2. Right to consult and be defended by lawyer\n3. Right to be produced before magistrate within 24 hours\n4. Right not to be detained beyond 24 hours without magistrate's authority\n\nPreventive Detention:\n• Detention without trial to prevent future crime\n• Article 22(3) to 22(7) deal with preventive detention\n• Safeguards: Advisory Board, maximum period, grounds of detention\n\nPreventive Detention Laws:\n• National Security Act, 1980\n• Conservation of Foreign Exchange and Prevention of Smuggling Activities Act (COFEPOSA), 1974\n• Prevention of Terrorism Act (POTA) - repealed\n• Unlawful Activities Prevention Act (UAPA), 1967\n\nLandmark Cases:\n• A.K. Gopalan v. State of Madras (1950)\n• Maneka Gandhi v. Union of India (1978)\n• Kartar Singh v. State of Punjab (1994)",
            keywords: ["arrest", "detention", "article 22", "preventive detention", "advisory board"],
            examTips: "Article 22 provides safeguards against arbitrary arrest and detention. Preventive detention is an exception with specific safeguards."
          }
        ]
      }
    ]
    ...
    topics: [
      {
        ...
        title: "President of India - Constitutional Head",
        description: "The President is the constitutional head of the Indian Republic",
        concepts: [
          {
            id: "president_position",
            title: "Constitutional Position of President",
            content: "The President of India is the constitutional head of state and the first citizen of India. The office combines the dignity of the state with the practical needs of executive government.\n\nKey Features:\n• Head of State (not Head of Government)\n• Symbol of unity, integrity and solidarity of the nation\n• Nominal executive (real executive is Council of Ministers)\n• Integral part of Parliament\n• Supreme Commander of Defence Forces\n\nComparison with Other Systems:\n• Unlike US President (both Head of State and Government)\n• Similar to British Monarch (constitutional head)\n• Follows Westminster model\n\nConstitutional Articles:\n• Articles 52-62 deal with President\n• Article 52: There shall be a President of India\n• Article 53: Executive power vested in President\n• Article 54: Election of President\n• Article 61: Impeachment procedure",
            keywords: ["president", "constitutional head", "head of state", "nominal executive"],
            examTips: "President is Head of State, not Government. PM is Head of Government. President acts on aid and advice of Council of Ministers."
          },
          {
            id: "president_election",
            title: "Election of President",
            content: "The President is elected by an Electoral College through proportional representation by single transferable vote.\n\nElectoral College Composition:\n• Elected members of Lok Sabha\n• Elected members of Rajya Sabha\n• Elected members of State Legislative Assemblies\n• Elected members of UT Legislative Assemblies (Delhi, Puducherry)\n\nNote: Nominated members cannot vote\n\nValue of Vote Calculation:\nFor MLA: (Total population of state ÷ Total elected MLAs) ÷ 1000\nFor MP: (Total value of all MLAs ÷ Total elected MPs in Parliament)\n\nQualifications (Article 58):\n• Citizen of India\n• Completed 35 years of age\n• Qualified to be elected as Lok Sabha member\n• Should not hold office of profit\n\nDisqualifications:\n• Office of profit under Government\n• Unsound mind (declared by court)\n• Undischarged insolvent\n\nElection Process:\n• Secret ballot\n• Single transferable vote\n• Proportional representation\n• Absolute majority required\n• If no absolute majority, preferences counted\n\nElection Disputes:\n• Supreme Court has exclusive jurisdiction\n• Cannot be questioned in any other court\n• Election cannot be challenged on ground of vacancy in Electoral College",
            keywords: ["electoral college", "proportional representation", "single transferable vote", "qualifications"],
            examTips: "Remember the value of vote formula and that nominated members cannot participate in presidential election."
          },
          {
            id: "president_powers",
            title: "Powers and Functions of President",
            content: "The President exercises executive, legislative, judicial, diplomatic, military and emergency powers.\n\nEXECUTIVE POWERS:\n• Appoints Prime Minister and Council of Ministers\n• Appoints Governors of States\n• Appoints Chief Justice and Judges of Supreme Court and High Courts\n• Appoints Attorney General, Comptroller and Auditor General\n• Appoints Chief Election Commissioner and Election Commissioners\n• Appoints members of UPSC, Finance Commission\n• Administers Union Territories through Administrators\n\nLEGISLATIVE POWERS:\n• Summons, prorogues and dissolves Parliament\n• Addresses joint session of Parliament\n• Can send messages to Parliament\n• Nominates 12 members to Rajya Sabha\n• Nominates 2 Anglo-Indian members to Lok Sabha (abolished by 104th Amendment)\n• Assent to bills (can return non-money bills once)\n• Promulgates ordinances when Parliament not in session\n\nJUDICIAL POWERS:\n• Appoints Chief Justice and judges\n• Can seek advisory opinion from Supreme Court (Article 143)\n• Power of pardon, reprieve, respite, remission, commutation (Article 72)\n• Pardoning power extends to court martial cases\n\nDIPLOMATIC POWERS:\n• Represents India in international affairs\n• Sends and receives ambassadors\n• Negotiates and concludes treaties (with Parliament approval)\n\nMILITARY POWERS:\n• Supreme Commander of Defence Forces\n• Can declare war or conclude peace (on advice of Council of Ministers)\n• All military appointments made in his name\n\nEMERGENCY POWERS:\n• National Emergency (Article 352)\n• President's Rule in States (Article 356)\n• Financial Emergency (Article 360)",
            keywords: ["executive powers", "legislative powers", "judicial powers", "emergency powers", "pardoning power"],
            examTips: "President has extensive powers but exercises them on aid and advice of Council of Ministers. Emergency powers are most significant."
          },
          {
            id: "president_emergency",
            title: "Emergency Powers of President",
            content: "The President can declare three types of emergencies under the Constitution.\n\n1. NATIONAL EMERGENCY (Article 352):\nGrounds:\n• War\n• External aggression\n• Armed rebellion (44th Amendment changed 'internal disturbance')\n\nProcedure:\n• President declares on written advice of Council of Ministers\n• Must be approved by both Houses within one month\n• Approved by special majority (majority of total membership + 2/3rd of present and voting)\n• Can be revoked by Lok Sabha by simple majority\n• Maximum duration: 6 months at a time\n\nEffects:\n• Fundamental Rights under Articles 19 suspended\n• Centre can give directions to states\n• Parliament can make laws on state subjects\n• President can modify financial arrangements\n\nHistorical Declarations:\n• 1962: Chinese aggression\n• 1971: Pakistan war\n• 1975: Internal emergency (most controversial)\n\n2. PRESIDENT'S RULE (Article 356):\nGrounds:\n• Constitutional machinery in state has failed\n• State government cannot be carried on according to Constitution\n\nProcedure:\n• President acts on Governor's report or otherwise satisfied\n• Parliamentary approval within 2 months\n• Initially for 6 months, extendable up to 3 years\n• Can be revoked anytime\n\nEffects:\n• State government dismissed\n• President administers state through Governor\n• State legislature suspended or dissolved\n• Parliament can make laws for the state\n\nLandmark Cases:\n• S.R. Bommai v. Union of India (1994) - judicial review of President's Rule\n\n3. FINANCIAL EMERGENCY (Article 360):\nGrounds:\n• Financial stability or credit of India threatened\n\nProcedure:\n• President declares\n• Parliamentary approval within 2 months\n• No maximum duration specified\n\nEffects:\n• Centre can give financial directions to states\n• Can reduce salaries of judges, government servants\n• Money bills of states reserved for President's consideration\n\nNote: Never declared so far",
            keywords: ["national emergency", "president's rule", "financial emergency", "article 352", "article 356"],
            examTips: "44th Amendment made emergency provisions more stringent. S.R. Bommai case established judicial review of President's Rule."
          },
          {
            id: "president_impeachment",
            title: "Impeachment of President",
            content: "The President can be removed from office through impeachment for violation of Constitution.\n\nGrounds for Impeachment:\n• Violation of Constitution\n• No specific charges mentioned in Constitution\n• Interpreted as serious misconduct\n\nProcedure (Article 61):\n1. Charges preferred by either House of Parliament\n2. Minimum 1/4th members must sign the proposal\n3. 14 days notice must be given\n4. Resolution passed by 2/3rd majority of total membership\n5. Other House investigates the charges\n6. President has right to appear and be represented\n7. If charges proved by 2/3rd majority, President stands removed\n\nSafeguards:\n• High majority required (2/3rd of total membership)\n• Both Houses must agree\n• Quasi-judicial procedure\n• Right of defense to President\n• 14 days notice\n\nComparison with US:\n• US: Impeachment by House, trial by Senate\n• India: Either House can initiate, other investigates\n• US: Simple majority for impeachment, 2/3rd for conviction\n• India: 2/3rd majority in both stages\n\nHistorical Context:\n• No President has been impeached in India\n• Impeachment motion against President K.R. Narayanan was withdrawn\n\nActing President:\n• Vice-President acts as President during vacancy\n• If both offices vacant, Chief Justice of India acts\n• Election must be held within 6 months",
            keywords: ["impeachment", "article 61", "violation of constitution", "2/3rd majority"],
            examTips: "Impeachment requires 2/3rd majority of total membership of both Houses. No President has been impeached in India so far."
          }
        ]
      }
    ]
    ...
    topics: [
      {
        ...
        title: "Structure and Composition of Parliament",
        description: "Bicameral legislature of the Union",
        concepts: [
          {
            id: "parliament_overview",
            title: "Parliament - The Union Legislature",
            content: "Parliament is the supreme legislative body of India consisting of President, Lok Sabha and Rajya Sabha.\n\nComposition:\n• President of India\n• Lok Sabha (House of the People)\n• Rajya Sabha (Council of States)\n\nLOK SABHA:\n• Maximum strength: 552 members\n• Current strength: 543 elected + 2 nominated (Anglo-Indians) - now abolished\n• Direct election by people\n• Term: 5 years (can be extended during emergency)\n• Presiding Officer: Speaker\n\nConstituency Distribution:\n• States: 530 seats\n• Union Territories: 13 seats\n• Based on 2001 Census (frozen till 2026)\n\nRAJYA SABHA:\n• Maximum strength: 250 members\n• Current strength: 238 elected + 12 nominated\n• Indirect election by State Legislative Assemblies\n• Term: 6 years (1/3rd retire every 2 years)\n• Presiding Officer: Vice-President of India\n\nNominated Members:\n• 12 members nominated by President\n• Persons with special knowledge in literature, science, art, social service\n• Examples: Sachin Tendulkar, Lata Mangeshkar, A.R. Rahman\n\nQualifications for Membership:\n• Citizen of India\n• Lok Sabha: 25 years, Rajya Sabha: 30 years\n• Not hold office of profit\n• Not be of unsound mind\n• Not be undischarged insolvent",
            keywords: ["parliament", "lok sabha", "rajya sabha", "bicameral", "composition"],
            examTips: "Parliament consists of President + Lok Sabha + Rajya Sabha. Remember the maximum and current strength of both Houses."
          }
        ]
      }
    ]
...
export const LANDMARK_CASES = [
  {
    ...
    date: "1950-05-19",
    court: "Supreme Court",
    judges: "6-judge bench",
    significance: "First major interpretation of Article 21 - set an early, narrow reading of personal liberty",
    facts: "A.K. Gopalan, detained under the Preventive Detention Act 1950, challenged his detention as violating Articles 19, 21 and 22",
    judgment: "The Court held Article 21 only requires a 'procedure established by law', not the American-style 'due process of law'; each fundamental right was treated as a separate, watertight compartment",
    impact: "Gave the state wide detention powers for nearly three decades until Maneka Gandhi (1978) overturned this narrow approach",
    category: "Fundamental Rights",
    keywords: ["Article 21", "preventive detention", "procedure established by law"]
  },
  {
    id: "golaknath",
    title: "I.C. Golak Nath v. State of Punjab (1967)",
    date: "1967-02-27",
    court: "Supreme Court",
    judges: "11-judge bench (6:5 majority)",
    significance: "Held Parliament cannot amend or take away Fundamental Rights",
    facts: "Punjab's land ceiling law was challenged; the case tested whether a constitutional amendment is 'law' under Article 13(2)",
    judgment: "By a 6:5 majority, the Court ruled a constitutional amendment is 'law' under Article 13(2) and so cannot abridge Part III (Fundamental Rights), applying this ruling prospectively only",
    impact: "Prompted Parliament to pass the 24th Amendment (1971) restoring its amending power, setting up the later showdown in Kesavananda Bharati",
    category: "Constitutional Law",
    keywords: ["Article 13", "Article 368", "amending power", "prospective overruling"]
  },
  {
    id: "kesavananda_bharati",
    ...
    date: "1973-04-24",
    court: "Supreme Court",
    judges: "13-judge bench (7:6 majority) - the largest bench ever to sit in India",
    significance: "Established the Basic Structure Doctrine",
    facts: "The Kerala Land Reforms Act was challenged along with the scope of Parliament's power to amend the Constitution under Article 368",
    judgment: "Parliament can amend any part of the Constitution, including Fundamental Rights, but cannot alter or destroy its 'basic structure' - core features such as democracy, secularism, federalism, judicial review and separation of powers",
    impact: "The single most important constitutional ruling in India's history; it remains the standard by which every later amendment is tested",
    category: "Constitutional Law",
    keywords: ["basic structure", "constitutional amendment", "Article 368", "judicial review"]
  },
  {
    ...
    date: "1975-11-07",
    court: "Supreme Court",
    judges: "5-judge bench",
    significance: "First case to actually apply the Basic Structure Doctrine to strike down a constitutional amendment",
    facts: "Raj Narain's election petition against Prime Minister Indira Gandhi's 1971 election win was pending when Parliament inserted Article 329A via the 39th Amendment to place PM/Speaker election disputes beyond judicial review",
    judgment: "The Court struck down clause (4) of Article 329A, holding that free and fair elections, democracy, and judicial review are part of the Constitution's basic structure and cannot be removed by amendment",
    impact: "Reaffirmed and applied Kesavananda Bharati's basic structure test for the first time to actually invalidate a specific amendment",
    category: "Constitutional Law",
    keywords: ["basic structure", "39th Amendment", "free and fair elections", "judicial review"]
  },
  {
    id: "adm_jabalpur",
    ...
    date: "1976-04-28",
    court: "Supreme Court",
    judges: "5-judge bench (4:1 majority; Justice H.R. Khanna dissented)",
    significance: "The 'Habeas Corpus case' - one of the most criticised judgments in Indian legal history",
    facts: "During the 1975 Emergency, thousands were detained without trial; high courts had allowed habeas corpus petitions, which the government appealed",
    judgment: "The majority held that during a National Emergency, the right to move courts for enforcement of Article 21 (life and personal liberty) itself stood suspended; Justice Khanna alone dissented, famously defending liberty even in an emergency",
    impact: "Widely regarded as the Supreme Court's darkest hour; its reasoning was effectively repudiated by the Court itself in the K.S. Puttaswamy privacy judgment (2017), and Justice Khanna's dissent is now celebrated",
    category: "Fundamental Rights",
    keywords: ["Emergency", "Article 21", "habeas corpus", "Justice Khanna dissent"]
  },
  {
    id: "maneka_gandhi",
    ...
    significance: "Transformed Article 21 - Right to Life and Personal Liberty",
    facts: "Maneka Gandhi's passport was impounded by the government 'in public interest' without being given any reasons",
    judgment: "The Court held that the 'procedure established by law' under Article 21 must itself be fair, just and reasonable - not arbitrary - and that Articles 14, 19 and 21 are interlinked, not watertight compartments",
    impact: "Overturned the narrow Gopalan approach and became the foundation for later reading a wide range of rights - privacy, livelihood, clean environment, dignity - into Article 21",
    category: "Fundamental Rights",
    keywords: ["Article 21", "fair procedure", "personal liberty", "natural justice"]
  },
  {
    id: "minerva_mills",
    ...
    date: "1980-07-31",
    court: "Supreme Court",
    judges: "5-judge bench (4:1 on Section 4)",
    significance: "Held that the harmony and balance between Fundamental Rights and Directive Principles is itself part of the basic structure",
    facts: "The 42nd Amendment (1976) had inserted clauses giving constitutional amendments complete immunity from judicial review and giving Directive Principles overriding primacy over Fundamental Rights",
    judgment: "The Court struck down these clauses, holding that Parliament's limited amending power cannot be turned into an unlimited power, and that Fundamental Rights and Directive Principles must coexist in harmony",
    impact: "Reinforced Kesavananda Bharati and confirmed judicial review as a permanent, unamendable feature of the Constitution",
    category: "Constitutional Law",
    keywords: ["basic structure", "42nd Amendment", "Directive Principles", "judicial review"]
  },
  {
    id: "olga_tellis",
    ...
    court: "Supreme Court",
    judges: "5-judge bench",
    significance: "Extended Article 21 to include the right to livelihood",
    facts: "Pavement and slum dwellers in Bombay were to be evicted by the Municipal Corporation without notice or an opportunity to be heard",
    judgment: "The Court held that the right to life under Article 21 includes the right to livelihood, since depriving a person of their means of earning is as good as depriving them of life - though eviction itself was allowed if done through a fair procedure",
    impact: "A landmark for socio-economic rights jurisprudence, cited in later cases on housing, rehabilitation and the rights of the urban poor",
    category: "Fundamental Rights",
    keywords: ["Article 21", "right to livelihood", "eviction", "fair procedure"]
  },
  {
    id: "shah_bano",
    ...
    court: "Supreme Court",
    judges: "5-judge bench",
    significance: "Landmark ruling on maintenance rights for divorced Muslim women",
    facts: "Shah Bano, divorced by her husband through talaq, sought maintenance under Section 125 of the Code of Criminal Procedure, a secular law applicable to all citizens",
    judgment: "The Court held that Section 125 CrPC applies to all citizens regardless of religion, and a divorced Muslim woman unable to maintain herself is entitled to maintenance from her former husband",
    impact: "Triggered major political controversy; Parliament subsequently passed the Muslim Women (Protection of Rights on Divorce) Act, 1986, which restricted the ruling's direct application - the case remains central to debates on a Uniform Civil Code",
    category: "Personal Law",
    keywords: ["Section 125 CrPC", "maintenance", "Muslim personal law", "Uniform Civil Code"]
  },
  {
    id: "mc_mehta_oleum",
    title: "M.C. Mehta v. Union of India - Oleum Gas Leak Case (1986)",
    date: "1986-12-20",
    court: "Supreme Court",
    judges: "4-judge bench",
    significance: "Created the 'Absolute Liability' principle in Indian environmental and tort law",
    facts: "A leak of oleum gas from Shriram Foods and Fertilisers' Delhi plant caused injury to nearby residents, raising the question of the standard of liability for hazardous industries",
    judgment: "The Court went beyond the English rule of 'strict liability' (Rylands v. Fletcher) and held that an enterprise engaged in a hazardous activity owes an absolute and non-delegable duty, with no exceptions, to anyone harmed by an accident in its operations",
    impact: "Became the governing standard in Indian law for hazardous industry accidents, applied in later cases including the Bhopal Gas tragedy litigation",
    category: "Environmental Law",
    keywords: ["absolute liability", "hazardous industry", "Article 21", "environmental law"]
  },
  {
    id: "indra_sawhney",
    title: "Indra Sawhney v. Union of India - Mandal Commission Case (1992)",
    date: "1992-11-16",
    court: "Supreme Court",
    judges: "9-judge bench (6:3 majority)",
    significance: "Settled the constitutional framework for OBC reservations in government jobs",
    facts: "The Union Government's decision to implement the Mandal Commission's recommendation of 27% reservation for Other Backward Classes (OBCs) in public employment was challenged",
    judgment: "The Court upheld 27% OBC reservation but capped total reservations at 50% (except in extraordinary circumstances), and directed the exclusion of the 'creamy layer' - socially advanced members of OBCs - from reservation benefits",
    impact: "Remains the foundational precedent for every reservation policy debate in India, including the ongoing discussion on the 50% ceiling",
    category: "Reservation Policy",
    keywords: ["Article 16(4)", "OBC reservation", "50% ceiling", "creamy layer"]
  },
  {
    ...
    date: "1993-10-06",
    court: "Supreme Court",
    judges: "9-judge bench",
    significance: "Gave birth to the collegium system of judicial appointments",
    facts: "The case examined the correct interpretation of 'consultation' with the Chief Justice of India under Articles 124 and 217 in the appointment of judges",
    judgment: "The Court held that the Chief Justice of India's recommendation, made in consultation with a collegium of senior judges, has primacy over the executive's view in judicial appointments",
    impact: "Established the collegium system that still governs the appointment of judges to the Supreme Court and High Courts, later reaffirmed when the NJAC Amendment was struck down in 2015",
    category: "Judicial Independence",
    keywords: ["collegium system", "judicial appointments", "Article 124", "consultation"]
  },
  {
    id: "sr_bommai",
    ...
    court: "Supreme Court",
    judges: "9-judge bench",
    significance: "Laid down strict guidelines to prevent misuse of President's Rule",
    facts: "Several state governments, including Karnataka's under S.R. Bommai, had been dismissed under Article 356 (President's Rule); the constitutionality and scope of judicial review of such proclamations was challenged",
    judgment: "The Court held that a proclamation under Article 356 is subject to judicial review, that a floor test on the floor of the House - not the Governor's personal assessment - is the proper way to test majority, and that secularism and federalism are part of the basic structure",
    impact: "Sharply curbed the earlier routine and politically motivated misuse of President's Rule, one of the most consequential rulings for Indian federalism",
    category: "Federalism",
    keywords: ["Article 356", "President's Rule", "floor test", "federalism"]
  },
  {
    id: "vishaka",
    ...
    date: "1997-08-13",
    court: "Supreme Court",
    judges: "3-judge bench",
    significance: "First legal guidelines against sexual harassment at the workplace in India",
    facts: "A social worker in Rajasthan was gang-raped while attempting to prevent a child marriage; the case highlighted the complete absence of law addressing workplace sexual harassment",
    judgment: "In the absence of legislation, the Court laid down binding guidelines - the 'Vishaka Guidelines' - defining sexual harassment and requiring every workplace to have a complaints mechanism, treating them as enforceable law under Article 141",
    impact: "The Vishaka Guidelines governed workplace sexual harassment law for 16 years until Parliament codified them in the Sexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act, 2013",
    category: "Fundamental Rights",
    keywords: ["sexual harassment", "workplace rights", "Article 141", "gender justice"]
  },
  {
    id: "shreya_singhal",
    ...
    date: "2015-03-24",
    court: "Supreme Court",
    judges: "2-judge bench",
    significance: "A landmark ruling on free speech in the digital age",
    facts: "Section 66A of the Information Technology Act, 2000, which criminalised sending 'offensive' messages online, was challenged after several arbitrary arrests over social media posts",
    judgment: "The Court struck down Section 66A in its entirety as unconstitutionally vague and overbroad, holding it violated the freedom of speech and expression guaranteed under Article 19(1)(a)",
    impact: "A defining precedent for online free speech in India; the Court has since had to issue further orders because some states continued registering cases under the struck-down provision",
    category: "Fundamental Rights",
    keywords: ["Article 19(1)(a)", "Section 66A", "free speech", "digital rights"]
  },
  {
    id: "puttaswamy_privacy",
    title: "Justice K.S. Puttaswamy (Retd.) v. Union of India - Right to Privacy Case (2017)",
    date: "2017-08-24",
    court: "Supreme Court",
    judges: "9-judge bench (unanimous)",
    significance: "Declared the Right to Privacy a Fundamental Right",
    facts: "The case arose out of a challenge to the Aadhaar biometric identity scheme, which required the Court to first settle whether a fundamental right to privacy exists at all",
    judgment: "The Court unanimously held that the right to privacy is a fundamental right protected under Article 21 and Part III of the Constitution, overruling the contrary observations in the earlier Kharak Singh and ADM Jabalpur judgments",
    impact: "Became the foundation for later rulings on Aadhaar, Section 377 (Navtej Johar), and adultery, and remains central to India's ongoing data-protection law",
    category: "Fundamental Rights",
    keywords: ["Article 21", "right to privacy", "Aadhaar", "data protection"]
  },
  {
    id: "shayara_bano",
    title: "Shayara Bano v. Union of India - Triple Talaq Case (2017)",
    date: "2017-08-22",
    court: "Supreme Court",
    judges: "5-judge bench (3:2 majority)",
    significance: "Declared instant triple talaq (talaq-e-biddat) unconstitutional",
    facts: "Shayara Bano challenged the practice of talaq-e-biddat, where a Muslim husband could instantly and irrevocably divorce his wife by pronouncing 'talaq' three times in one sitting",
    judgment: "By a 3:2 majority, the Court held that instant triple talaq is manifestly arbitrary and violates Article 14, and struck it down",
    impact: "Led Parliament to pass the Muslim Women (Protection of Rights on Marriage) Act, 2019, criminalising the practice of instant triple talaq",
    category: "Personal Law",
    keywords: ["triple talaq", "Article 14", "Muslim personal law", "gender justice"]
  },
  {
    ...
    court: "Supreme Court",
    judges: "5-judge bench",
    significance: "Decriminalised consensual homosexual conduct between adults",
    facts: "Section 377 of the Indian Penal Code criminalised 'carnal intercourse against the order of nature'; the Delhi High Court had earlier read it down in Naz Foundation (2009), but this was reversed by the Supreme Court in Suresh Kumar Koushal (2013)",
    judgment: "A five-judge bench unanimously read down Section 377, holding that consensual sexual conduct between adults of the same sex in private is not a crime, while the provision continues to apply to non-consensual acts, acts with minors, and bestiality",
    impact: "A landmark moment for LGBTQ+ rights in India, overruling the Court's own earlier Koushal judgment and grounding the decision in dignity, autonomy and equality under Articles 14, 15, 19 and 21",
    category: "Fundamental Rights",
    keywords: ["Section 377", "LGBTQ+ rights", "Article 21", "dignity and autonomy"]
  },
  {
    id: "ayodhya_verdict",
    title: "M. Siddiq v. Mahant Suresh Das - Ayodhya Title Dispute (2019)",
    date: "2019-11-09",
    court: "Supreme Court",
    judges: "5-judge bench (unanimous)",
    significance: "Resolved the decades-old Ram Janmabhoomi-Babri Masjid title dispute",
    facts: "The case concerned civil suits over title to the 2.77-acre disputed site in Ayodhya, where the Babri Masjid stood until its demolition in 1992",
    judgment: "The Court unanimously held that the entire disputed site should be handed over to a trust for construction of a Hindu temple, while directing the government to allot an alternate 5-acre plot elsewhere in Ayodhya to the Sunni Central Waqf Board for a mosque",
    impact: "Brought a formal legal end to one of independent India's longest-running and most sensitive land disputes",
    category: "Land Dispute",
    keywords: ["Ayodhya", "title dispute", "Ram Janmabhoomi", "Babri Masjid"]
  }
];
...
export const QUIZ_QUESTIONS = {
  beginner: [
    ...
    },
    {
      ...
      options: ["Dr. A.P.J. Abdul Kalam", "Dr. Rajendra Prasad", "Dr. S. Radhakrishnan", "Zakir Hussain"],
      correctAnswer: 1,
  ...
  intermediate: [
    ...
    },
    {
      ...
      options: ["Emergency provisions", "President's Rule", "Financial Emergency", "National Emergency"],
      correctAnswer: 1,
      explanation: "Article 356 deals with President's Rule (State Emergency) when constitutional machinery fails in a state.",
    ...
    },
    {
      ...
      options: ["Britain", "USA", "Canada", "Australia"],
      correctAnswer: 1,
      explanation: "The concept of Judicial Review is borrowed from the USA, allowing courts to review the constitutionality of laws.",
      topic: "Judiciary",
      difficulty: "medium"
    }
  ],
  advanced: [
    ...
    {
      id: "a3",
      question: "Which article empowers the Supreme Court to review its own judgments?",
      options: ["Article 137", "Article 136", "Article 138", "Article 139"],
      correctAnswer: 0,
    ...
    },
    {
      ...
      correctAnswer: 1,
      explanation: "Colorable Legislation doctrine prevents legislature from doing indirectly what it cannot do directly due to lack of competence.",
      topic: "Constitutional Law",
      difficulty: "hard"
    }
  ],
  expert: [
    ...
    {
      id: "e2",
      question: "The 'Ratchet Theory' in constitutional amendments was propounded in which case?",
      options: ["Kesavananda Bharati", "Minerva Mills", "Waman Rao", "Indira Gandhi case"],
      correctAnswer: 2,
      explanation: "The Ratchet Theory was propounded in Waman Rao case, stating that amendments before Kesavananda Bharati are immune from challenge.",
      topic: "Constitutional Law",
      difficulty: "expert"
    }
  ]
